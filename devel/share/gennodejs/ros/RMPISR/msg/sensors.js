...
class sensors {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float32(obj.ir1, buffer, bufferOffset);
    // Serialize message field [ir2]
    bufferOffset = _serializer.float32(obj.ir2, buffer, bufferOffset);
    // Serialize message field [ir3]
    bufferOffset = _serializer.float32(obj.ir3, buffer, bufferOffset);
    // Serialize message field [ir4]
    bufferOffset = _serializer.float32(obj.ir4, buffer, bufferOffset);
    // Serialize message field [s1]
    bufferOffset = _serializer.float32(obj.s1, buffer, bufferOffset);
    // Serialize message field [s2]
    bufferOffset = _serializer.float32(obj.s2, buffer, bufferOffset);
    // Serialize message field [s5]
    bufferOffset = _serializer.float32(obj.s5, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.ir1 = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [ir2]
    data.ir2 = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [ir3]
    data.ir3 = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [ir4]
    data.ir4 = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [s1]
    data.s1 = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [s2]
    data.s2 = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [s5]
    data.s5 = _deserializer.float32(buffer, bufferOffset);
    return data;
  }
