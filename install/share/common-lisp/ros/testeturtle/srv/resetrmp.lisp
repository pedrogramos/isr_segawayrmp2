...
(cl:defmethod cl:initialize-instance :after ((m <resetrmp-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'resetrmp-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name testeturtle-srv:<resetrmp-request> is deprecated: use testeturtle-srv:resetrmp-request instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <resetrmp-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testeturtle-srv:pose-val is deprecated.  Use testeturtle-srv:pose instead.")
  (pose m))
...
(cl:defmethod cl:initialize-instance :after ((m <resetrmp-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'resetrmp-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name testeturtle-srv:<resetrmp-response> is deprecated: use testeturtle-srv:resetrmp-response instead.")))
